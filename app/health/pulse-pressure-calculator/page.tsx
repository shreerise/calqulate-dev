      ...
      <main id="main" className="flex-1">
        ...
        <section className="bg-gradient-to-br from-emerald-50 via-white to-lime-50 border-b border-slate-200">
          <div className="mx-auto max-w-5xl px-6 py-12 md:py-20">
            ...
            <p className="mt-4 text-lg md:text-xl text-slate-600 max-w-3xl text-pretty">
              Most people know their &quot;120 over 80,&quot; but few know the most important number inside that reading: your Pulse Pressure. Our pulse pressure calculator helps you understand how well your heart pumps and how flexible your arteries are.
            </p>
          ...
          <div className="mx-auto max-w-5xl px-6 py-6">
            <div className="flex items-start gap-3 rounded-2xl border border-emerald-200 bg-emerald-50/70 p-5 md:p-6">
              ...
              <p className="text-sm md:text-base leading-relaxed text-slate-700">
                Calqulate.net works out your pulse pressure from your systolic and diastolic numbers against recognised vascular standards. You get a narrow/wide classification and what it means for arterial health.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            ...
            <RelatedCalculators slug="pulse-pressure-calculator" />
