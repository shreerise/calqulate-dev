          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none mt-12 space-y-16">
              ...
              <section> 
                ...
                <blockquote><p className="mt-4 text-muted-foreground">
                  If you want to explore another precise way of evaluating body proportion, try our{" "}
                  <Link href="/health/ponderal-index-calculator" className="text-primary hover:underline">
                    Ponderal Index Calculator
                  </Link>
                  . It uses height cubed instead of height squared (like BMI) and is particularly useful for very tall or short individuals when assessing ideal body structure.
                </p>
                </blockquote>
              </section>
