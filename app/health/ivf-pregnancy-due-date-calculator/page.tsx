      ...
      <main id="main" className="flex-1">
          ...
          <div className="mx-auto max-w-5xl px-6 py-6">
            <div className="flex items-start gap-3 rounded-2xl border border-emerald-200 bg-emerald-50/70 p-5 md:p-6">
              ...
              <p className="text-sm md:text-base leading-relaxed text-slate-700">
                Calqulate.net calculates your due date from your embryo-transfer date, accurate for Day 3, 5, 6 and frozen transfers. You get your EDD plus a full pregnancy milestone timeline.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            ...
            <RelatedCalculators slug="ivf-pregnancy-due-date-calculator" />
