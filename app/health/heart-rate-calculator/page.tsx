          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-base text-muted-foreground mt-3">
                Knowing your precise numbers turns random exercise into a strategic routine. A target heart rate calculator helps you measure exercise intensity accurately so you can train safely and reach your fitness goals faster.
              </p>
            </div>
