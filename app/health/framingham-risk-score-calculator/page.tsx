        ...
        <section className="bg-gradient-to-br from-emerald-50 via-white to-lime-50 border-b border-slate-200">
          <div className="mx-auto max-w-5xl px-6 py-12 md:py-20">
            ...
            <p className="mt-4 text-lg md:text-xl text-slate-600 max-w-3xl text-pretty">
              Is your heart older than you are? Cardiovascular disease remains the leading cause of mortality globally, but it is also one of the most preventable. For over 70 years, the <strong> Framingham Risk Calculator</strong> has served as the gold standard for predicting heart health.
            </p>
