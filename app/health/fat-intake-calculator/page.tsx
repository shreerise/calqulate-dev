      ...
      <main id="main" className="flex-1">
        ...
        <section className="bg-gradient-to-br from-emerald-50 via-white to-lime-50 border-b border-slate-200">
          <div className="mx-auto max-w-5xl px-6 py-12 md:py-20">
            ...
            <p className="mt-4 text-lg md:text-xl text-slate-600 max-w-3xl text-pretty">
              Find your perfect balance. Whether you are doing Keto, cutting for summer, or just trying to eat healthier, our tool calculates exactly <strong>how many grams of fat</strong> you need daily based on your body and goals.
            </p>
          ...
          <div className="mx-auto max-w-5xl px-6 py-6">
            <div className="flex items-start gap-3 rounded-2xl border border-emerald-200 bg-emerald-50 p-5 md:p-6">
              ...
              <p className="text-sm md:text-base leading-relaxed text-slate-700">
                Calqulate.net sets your daily fat target from your calories and goal, aligned with established dietary guidelines. You get grams split into saturated, unsaturated and trans, with diet presets.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-5xl mx-auto">
            ...
            <RelatedCalculators slug="fat-intake-calculator" />
