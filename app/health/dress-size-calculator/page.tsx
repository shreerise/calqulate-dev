          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-8">              <h1 className="text-3xl md:text-4xl font-bold text-balance mb-4">
              ...
              <p className="text-lg text-muted-foreground text-pretty">
                Stop guessing your dress size. Our Dress Size Calculator uses your bust, waist, and hip
                measurements to give you accurate sizes across US, UK, EU, and Indian brands — with smart
                advice for your body shape, dress style, and fit preference.
              </p>
              <p className="text-base text-muted-foreground mt-3">
                Whether you&apos;re shopping online, buying a wedding dress, or tired of ordering the wrong
                size, our tool helps you find the right fit in seconds.
              </p>
            </div>
