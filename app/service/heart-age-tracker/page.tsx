...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://calqulate.net/service/heart-age-tracker" },
  openGraph: {
    ...
    url: "https://calqulate.net/service/heart-age-tracker",
    type: "website",
    siteName: "Calqulate",
  },
};
...
const config: TrackerLandingConfig = {
  jsonLd: {
    ...
    canonical: "https://calqulate.net/service/heart-age-tracker",
  },
...
export default function HeartAgeTrackerPage() {
