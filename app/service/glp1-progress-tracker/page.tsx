...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://calqulate.net/service/glp1-progress-tracker" },
  openGraph: {
    ...
    url: "https://calqulate.net/service/glp1-progress-tracker",
    type: "website",
    siteName: "Calqulate",
  },
};
...
export default function Glp1TrackerLanding() {
  return (
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-10 px-4 py-14 sm:py-20 lg:grid-cols-2 lg:gap-12">
          <Reveal>
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <Link href="/signup?next=/dashboard/glp1" className={btnGreen}>Start free <ArrowRight className="h-4 w-4" /></Link>
            ...
            <Reveal>
              <div className="flex h-full flex-col rounded-2xl border border-line bg-surface p-7">
                ...
                <div className="mt-6 flex flex-col gap-2">
                  <Link href="/health/glp-1-dose-calculator" className={`${btnGreen} w-full`}>Open the free GLP-1 calculator <ArrowRight className="h-4 w-4" /></Link>
                  <Link href="/signup?next=/dashboard/glp1" className={`${btnOutline} w-full`}>Start the free tracker</Link>
                </div>
              </div>
            </Reveal>
        ...
        <div className="mx-auto max-w-3xl px-4">
          <Reveal>
            ...
            <div className="mt-7 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link href="/signup?next=/dashboard/glp1" className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-7 py-3 text-sm font-bold text-brand-800 shadow-sm transition-all duration-150 hover:-translate-y-0.5">
                Start free at calqulate.net <ArrowRight className="h-4 w-4" />
              </Link>
