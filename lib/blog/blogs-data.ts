...
export const blogs: Blog[] = [
  ...
  {
    slug: "how-to-measure-body-shape",
    title: "How to Measure Your Body Shape at Home",
    description:
      "Step-by-step measurement guide — bust, waist, hips, and shoulders. Use our calculator to instantly identify your body type.",
    category: "Body Shape",
    intent: "Self-identification",
    uspFeature: "Measurement assistant",
    featuredImage: "/images/blogs/measure-body-shape-cover.png",
    readTime: "5 min read",
    publishedAt: "2026-05-08",
    cta: "Measure Now",
    ctaHref: "/health/body-shape-calculator",
  ...
  {
    slug: "best-hairstyles-for-round-face",
    title: "Best Hairstyles for Round Face",
    description:
    ...
    featuredImage: "/images/blogs/hairstyles-round-face-cover.png",
    readTime: "7 min read",
    publishedAt: "2026-05-08",
  ...
  {
    slug: "best-glasses-for-face-shape",
    title: "Best Glasses for Face Shape",
    description:
    ...
    featuredImage: "/images/blogs/glasses-face-shape-cover.png",
    readTime: "6 min read",
    publishedAt: "2026-05-08",
    cta: "Find My Frames",
    ctaHref: "/health/face-shape-calculator",
