...
const calculatorCategories = [
  {
    ...
    calculators: [
      ...
      { name: "Estimated Average Glucose (EAG) Calculator", href: "/health/estimated-average-glucose-calculator" },
      ...
      { name: "Child BMI Calculator", href: "/health/child-bmi-calculator" },
      ...
      { name: "Metabolic Age Calculator", href: "/health/metabolic-age-calculator" },
