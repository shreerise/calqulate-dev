  ...
  return (
    <div className="space-y-6">
      <section className="rounded-2xl border bg-white p-6">
        ...
        <button onClick={exportData} className="mt-4 rounded-lg border border-gray-300 px-4 py-3 text-sm font-medium hover:bg-gray-50">
          Download my data
        </button>
      </section>
      ...
      <section className="rounded-2xl border border-red-200 bg-red-50/40 p-6">
        ...
        <input
          ...
          className="mt-3 w-full rounded-lg border border-gray-300 px-3 py-2 text-sm sm:w-48"
          placeholder="DELETE"
        />
        <div>
          <button
            ...
            className="mt-3 rounded-lg bg-red-600 px-4 py-3 text-sm font-semibold text-white hover:bg-red-700 disabled:opacity-50"
          >
