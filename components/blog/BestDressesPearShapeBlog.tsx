...
const extendedFAQs = [
  ...
  },
  {
    ...
    a: "Monochromatic outfits from waist to toe elongate the body significantly. Pointed-toe shoes, high-waist bottoms, and midi-length skirts with a high slit all add perceived height.",
  },
  {
...
export default function BestDressesPearShapeBlog({ blog }: Props) {
  return (
    <article className="bg-white">
      ...
      <header className="relative overflow-hidden bg-gradient-to-br from-rose-50 via-white to-emerald-50">
        <div className="mx-auto grid max-w-6xl gap-10 px-6 py-16 md:grid-cols-2 md:py-24">
          <div className="flex flex-col justify-center">
            ...
            {/* ── IMPROVED INTRO COPY (pain → promise → guide) */}
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:gap-16">
              ...
              <nav className="space-y-2">
                {tocItems.map((item) => (
                  <a
                    key={item.id}
                    href={`#${item.id}`}
                    className="block text-sm text-slate-600 hover:text-rose-600 transition-colors py-0.5 leading-snug"
                  >
                    {item.label}
                  </a>
                ))}
          ...
          <div className="min-w-0 flex-1 max-w-3xl">
            ...
            <section id="what-is-pear">
              ...
              {/* ── HOW TO KNOW IF YOU'RE PEAR SHAPE (new) */}
            ...
            {/* ── COMMON PROBLEMS (new emotional section) ── */}
            ...
            <section id="dress-cuts" className="mt-20">
              ...
              <p className="mt-4 text-lg leading-8 text-slate-600">
                ...
                the best shoulder-to-hip balance for pear-shaped women — ranked by fit score.
              </p>
      ...
      {/* ── EXTENDED FAQ (new + original merged) ───── */}
