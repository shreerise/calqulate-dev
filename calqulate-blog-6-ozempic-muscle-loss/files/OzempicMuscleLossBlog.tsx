    ...
    <article className="bg-white">
      ...
      <div className="mx-auto max-w-4xl px-6 py-16 md:py-24">
        ...
        <div className="prose prose-slate prose-lg max-w-none prose-headings:font-bold prose-headings:text-slate-900 prose-p:text-slate-700 prose-a:text-emerald-600 prose-strong:text-slate-900">
          <h2>The Part Nobody Warned You About</h2>
          <p>
          ...
          <p>
            ...
            analysis found that roughly <strong>40% of the weight lost came
          ...
          <p>
            The good news is that muscle loss is a side effect you can{" "}
            <em>manage</em> — not a sentence. But you can&rsquo;t fix what you
            ...
            body?{" "}
            <a href={GLP1_FREE_TRACKER_URL}>Try the GLP-1 tracker free</a>.
          </p>
        </div>
